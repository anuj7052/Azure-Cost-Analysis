...
import { ArrowDownRight, ArrowUpRight, CalendarDays, ChevronRight, Minus, X } from 'lucide-react';
import {
  Area, AreaChart, CartesianGrid, ResponsiveContainer, Tooltip, XAxis, YAxis,
} from 'recharts';

import { useChartTheme } from '../../store/useTheme';
import { dayDetail, serviceDetail } from '../../utils/boqTrend';
    ...
    <div className="border-t border-slate-800">
      <div className="flex items-start justify-between gap-3 px-5 py-3">
        <div>
          ...
          {detail.date >= new Date().toISOString().slice(0, 10) && <p className="mt-1 text-xs text-amber-400">This day is still being billed; a decrease is not yet a saving.</p>}
          {detail.budget !== null && (
      ...
      <div className="px-2 pb-2">
        <ResponsiveContainer width="100%" height={150}>
          <AreaChart
            ...
            onClick={(e) => {
              const d = clickedPoint(e, detail.points)?.date;
              if (d) onPickDay?.(d);
            }}
